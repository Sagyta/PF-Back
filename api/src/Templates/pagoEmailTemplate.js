const pagoTemplate = ()=>{
                    ...
                    <tr>
                        <td class="esd-email-paddings" valign="top">
                            ...
                            <table cellpadding="0" cellspacing="0" class="es-content" align="center">
                                <tbody>
                                    <tr>
                                        <td class="esd-stripe" align="center" esd-custom-block-id="82644">
                                            <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600">
                                                <tbody>
                                                    <tr>
                                                        <td class="esd-structure es-p40t es-p40b es-p15r es-p15l" align="left" esd-custom-block-id="78476">
                                                                        ...
                                                                        <td width="570" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-text es-m-txt-c es-p40t es-p40b">
                                                                                            <p style="font-size: 18px; color: #999999;">El pago&nbsp;fue registrado con éxito.</p>
                                                                                            <p style="font-size: 18px; color: #999999;">Ya puedes ver en tu perfil el detalle.</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure es-p20t es-p20b es-p20r es-p20l" esd-general-paddings-checked="false" align="left" style="background-color: #010101;" bgcolor="#010101">
                                                            ...
                                                            <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p0r esd-container-frame" width="178" valign="top" align="center">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr class="es-mobile-hidden">
                                                                                        <td class="esd-block-text" align="left">
                                                                                            <h4 style="color: #ffffff;">ITEM</h4>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure esdev-adapt-off es-p20t es-p15b es-p15r es-p15l" esd-general-paddings-checked="false" align="left">
                                                                    ...
                                                                    <tr>
                                                                        <td class="esdev-mso-td" valign="top">
                                                                            <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="es-m-p0r esd-container-frame" width="120" valign="top" align="center">
                                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td class="esd-block-image es-p20r" align="left" style="font-size: 0px;"><a href target="_blank"><img src="${picture_url}" alt width="100" style="display: block;"></a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td width="600" class="esd-container-frame" align="center" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-spacer es-p5t es-p5b es-p15r es-p15l" style="font-size:0">
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure esdev-adapt-off es-p15t es-p15r es-p15l" esd-general-paddings-checked="false" align="left" style="background-position: center top;">
                                                            <table width="100%" cellpadding="0" cellspacing="0" class="esdev-mso-table">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esdev-mso-td" valign="top">
                                                    ...
                                                    <tr>
                                                        <td class="esd-structure es-p40t es-p40b es-p10r es-p10l" align="left">
                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                                <tbody>
                                                                    <tr>
    ...
    <![endif]-->
                            ...
                            cellspacing="0"><tr><td width="175" valign="top"><![endif]-->
                                                            <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b esd-container-frame" width="175" align="left">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="center" class="esd-block-social es-p20t es-m-txt-c" style="font-size:0">
                                                                                            <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="center" valign="top" esd-tmp-icon-type="facebook" class="es-p10r"><a target="_blank" href="https://facebook.com.clubHenry"><img src="https://vpcaob.stripocdn.email/content/assets/img/social-icons/logo-white/facebook-logo-white.png" alt="Fb" title="Facebook" width="32"></a></td>
                                                                                                        <td align="center" valign="top" esd-tmp-icon-type="twitter" class="es-p10r"><a target="_blank" href="https://twitter.com/clubHenry"><img src="https://vpcaob.stripocdn.email/content/assets/img/social-icons/logo-white/twitter-logo-white.png" alt="Tw" title="Twitter" width="32"></a></td>
                                                                                                        <td align="center" valign="top" esd-tmp-icon-type="instagram"><a target="_blank" href="https://instagram.com/clubHenry"><img src="https://vpcaob.stripocdn.email/content/assets/img/social-icons/logo-white/instagram-logo-white.png" alt="Ig" title="Instagram" width="32"></a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                            ...
                                                            <!--[if mso]></td><td width="20"></td><td width="365" valign="top"><![endif]-->
                                                            <table class="es-right" cellspacing="0" cellpadding="0" align="right">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="esd-container-frame" width="365" align="left">
                                                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="left" class="esd-block-text es-m-txt-c es-p40t es-p15b">
                                                                                            <p>© 2022 Club deportivo Henry, Inc. Todos los derechos reservados.</p>
                                                                                            <p>Brandsen 805, Barrio de La&nbsp;&nbsp;<em>Boca</em>&nbsp;, Ciudad de Buenos Aires&nbsp;, 23467898</p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
